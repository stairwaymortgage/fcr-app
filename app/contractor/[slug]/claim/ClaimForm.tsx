    ...
    >
      ...
      <div>
        <button
          ...
          className={`w-full bg-navy px-6 py-4 font-mono text-[12.5px] font-semibold uppercase tracking-[0.06em] text-paper transition-colors hover:bg-navy-light disabled:opacity-50 ${FOCUS_RING_PAPER}`}
        >
